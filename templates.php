            ...
            <div class="row">
                ...
                foreach ($templates as $template) {
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        <div class="template <?php /** @noinspection PhpUndefinedConstantInspection */
                        echo $template['location'] == SELECTED_CLIENTS_TEMPLATE ? 'current_template' : ''; ?>">
                            <div class="col-xs-12">
                                <div class="images">
                                    <?php
                                    if (!empty($template['cover'])) {
                                        ?>
                                        <div class="cover">
                                            <img src="<?php echo html_output($template['cover']); ?>"
                                                 alt="<?php echo html_output($template['name']); ?>">
                                        </div>
                                        <?php
                                    } ?>
                                    <div class="screenshot">
                                        <img src="<?php echo html_output($template['screenshot']); ?>"
                                             alt="<?php echo html_output($template['name']); ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-4">
                                <div class="buttons">
                                    ...
                                    if ($template['location'] == SELECTED_CLIENTS_TEMPLATE) {
                                        ...
                                        ?>
                                        <a href="templates.php?activate_template=<?php echo $template['location']; ?>"
