...
function show_search_form($action = '')
{
    ...
    <form action="<?php echo $action; ?>" name="form_search" method="get" class="form-inline">
        ...
        <div class="form-group group_float">
            <input type="text" name="search" id="search" value="<?php echo isset($_GET['search']) && !empty($_GET['search']) ? html_output($_GET['search']) : ''; ?>" class="txtfield form_actions_search_box form-control" />
        </div>
