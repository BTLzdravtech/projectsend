...
<div class="options_column">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="ldap_host" id="ldap_host" class="form-control empty" value="<?php echo html_output(LDAP_HOST); ?>" />
        </div>
    </div>
    <div class="form-group">
        <label for="ldap_port" class="col-sm-4 control-label"><?php _e('Port','cftp_admin'); ?></label>
        <div class="col-sm-8">
            <input type="text" name="ldap_port" id="ldap_port" class="form-control empty" value="<?php echo html_output(LDAP_PORT); ?>" />
        </div>
    </div>
    <div class="form-group">
        <label for="ldap_basedn" class="col-sm-4 control-label"><?php _e('Base DN','cftp_admin'); ?></label>
        <div class="col-sm-8">
            <input type="text" name="ldap_basedn" id="ldap_basedn" class="form-control empty" value="<?php echo html_output(LDAP_BASEDN); ?>" />
        </div>
    </div>
    <div class="form-group">
        <label for="ldap_domain" class="col-sm-4 control-label"><?php _e('Domain','cftp_admin'); ?></label>
        <div class="col-sm-8">
            <input type="text" name="ldap_domain" id="ldap_domain" class="form-control empty" value="<?php echo html_output(LDAP_DOMAIN); ?>" />
        </div>
    </div>
</div>
