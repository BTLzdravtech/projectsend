    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <select name="ldap_signin_enabled" id="ldap_signin_enabled" class="form-control">
                ...
                echo (LDAP_SIGNIN_ENABLED == '1') ? 'selected="selected"' : ''; ?>><?php _e('Yes', 'cftp_admin'); ?></option>
                <option value="0" <?php /** @noinspection PhpUndefinedConstantInspection */
                echo (LDAP_SIGNIN_ENABLED == '0') ? 'selected="selected"' : ''; ?>><?php _e('No', 'cftp_admin'); ?></option>
            </select>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="ldap_host" id="ldap_host"
                   ...
                   echo LDAP_SIGNIN_ENABLED ? ' required' : ''; ?>"
                   value="<?php /** @noinspection PhpUndefinedConstantInspection */
                   echo html_output(LDAP_HOST); ?>"<?php /** @noinspection PhpUndefinedConstantInspection */
            echo LDAP_SIGNIN_ENABLED ? ' required' : ''; ?> />
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="ldap_port" id="ldap_port"
                   class="form-control<?php /** @noinspection PhpUndefinedConstantInspection */
                   echo LDAP_SIGNIN_ENABLED ? ' required' : ''; ?>"
                   value="<?php /** @noinspection PhpUndefinedConstantInspection */
                   echo html_output(LDAP_PORT); ?>"<?php /** @noinspection PhpUndefinedConstantInspection */
            echo LDAP_SIGNIN_ENABLED ? ' required' : ''; ?> />
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="ldap_basedn" id="ldap_basedn"
                   class="form-control<?php /** @noinspection PhpUndefinedConstantInspection */
                   echo LDAP_SIGNIN_ENABLED ? ' required' : ''; ?>"
                   value="<?php /** @noinspection PhpUndefinedConstantInspection */
                   echo html_output(LDAP_BASEDN); ?>"<?php /** @noinspection PhpUndefinedConstantInspection */
            echo LDAP_SIGNIN_ENABLED ? ' required' : ''; ?> />
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="ldap_domain" id="ldap_domain"
                   class="form-control<?php /** @noinspection PhpUndefinedConstantInspection */
                   echo LDAP_SIGNIN_ENABLED ? ' required' : ''; ?>"
                   value="<?php /** @noinspection PhpUndefinedConstantInspection */
                   echo html_output(LDAP_DOMAIN); ?>"<?php /** @noinspection PhpUndefinedConstantInspection */
            echo LDAP_SIGNIN_ENABLED ? ' required' : ''; ?> />
        </div>
    </div>
</div>
