...
<form action="<?php echo html_output($form_action); ?>" name="user_form" id="user_form" method="post" class="form-horizontal" data-form-type="<?php echo $user_form_type; ?>">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="username" id="username" class="form-control <?php echo !$disable_user ? 'required' : ''; ?>" maxlength="<?php echo MAX_USER_CHARS; ?>" value="<?php echo (isset($user_arguments['username'])) ? format_form_value($user_arguments['username']) : ''; ?>" <?php echo $disable_user ? 'readonly' : ''; ?> placeholder="<?php _e("Must be alphanumeric", 'cftp_admin'); ?>" required />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <div class="input-group">
                <input type="password" name="password" id="password" class="form-control <?php echo $require_pass ? 'required' : ''; ?> password_toggle" maxlength="<?php echo MAX_PASS_CHARS; ?>" <?php echo $is_ldap_user ? ' readonly' : ''; ?> />
