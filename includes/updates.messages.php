        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="system_msg">
                    <p>
                        <strong><?php _e('System Notice:', 'cftp_admin'); ?></strong> <?php _e('The database was updated to support this version of the software.', 'cftp_admin'); ?>
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-12">
                <div id="donations_message">
                    ...
                    <p><?php _e('Please remember that this tool is free software. If you find the system useful', 'cftp_admin'); ?>
                        <a href="<?php echo DONATIONS_URL; ?>"
                           target="_blank"><?php _e('please consider making a donation to support further development.', 'cftp_admin'); ?></a><br>
                ...
                <div class="alert alert-warning update_msg">
                    <div class="row">
                        ...
                        <div class="col-sm-4 text-right">
                            <a href="<?php echo $update_data->url; ?>" class="btn btn-default btn-xs"
                               target="_blank"><?php _e('Download', 'cftp_admin'); ?></a> <a
                                    href="<?php echo $update_data->chlog; ?>" target="_blank"
                                    class="btn btn-default btn-xs"><?php _e('Changelog', 'cftp_admin'); ?></a>
                        </div>
                    </div>
                </div>
                <?php
