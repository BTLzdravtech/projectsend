...
$json_strings = [
    ...
    'validation' => [
        ...
        'no_expires' => __('Expiration date was not completed','cftp_admin'),
        'no_file_expires' => __('File expires was not completed','cftp_admin'),
        'no_public' => __('Public was downloading not completed','cftp_admin'),
        'no_description' => __('Description was not completed','cftp_admin'),
