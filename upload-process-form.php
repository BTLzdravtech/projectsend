                                    ...
                                    <div class="checkbox form-group">
                                        <label for="exp_checkbox_<?php echo $i; ?>">
                                            <div class="input-group">
                                                <input type="hidden" name="file[<?php echo $i; ?>][expires]" id="exp_checkbox_<?php echo $i; ?>" value="1" <?php echo CURRENT_USER_LEVEL == '9' || CURRENT_USER_LEVEL == '8' || CURRENT_USER_LEVEL == '7' || CURRENT_USER_LEVEL == '0' ? 'checked="checked"' : ''; ?> />
                                            </div>
                                        </label>
                                    </div>
