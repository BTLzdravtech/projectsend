                                                    ...
                                                    if (!empty($row['expiry_date'])) {
                                                        ...
                                                        <div class="checkbox form-group">
                                                            <label for="exp_checkbox">
                                                                <div class="input-group">
                                                                    <input type="hidden" id="exp_checkbox" name="file[<?php echo $i; ?>][expires]" value="1" <?php echo $row['expires'] ? 'checked="checked"' : ''; ?> />
                                                                </div>
                                                            </label>
                                                        </div>
                                                        ...
                                                        <div class="checkbox form-group">
                                                            <label for="workspaces_checkbox">
                                                                <div class="input-group">
                                                                    <input type="checkbox" id="workspaces_checkbox" name="file[<?php echo $i; ?>][workspaces]" value="1" <?php echo $row['workspace_included'] ? 'checked="checked"' : ''; ?> /> <?php _e('Allow workspace downloading of this file.', 'cftp_admin'); ?>
                                                                </div>
                                                            </label>
                                                        </div>
                                                        ...
                                                        <div class="checkbox form-group">
                                                            <label for="pub_checkbox">
                                                                <div class="input-group">
                                                                    <input type="checkbox" id="pub_checkbox" name="file[<?php echo $i; ?>][public]" value="1" <?php echo $row['public_allow'] ? 'checked="checked"' : ''; ?> /> <?php _e('Allow public downloading of this file.', 'cftp_admin'); ?>
                                                                </div>
                                                            </label>
                                                        </div>
