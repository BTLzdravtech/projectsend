    ...
    <ul>
        <li id="search_box">
            <form action="" name="files_search" method="get">
                <input type="text" name="search" id="search_text"
                       ...
                       placeholder="<?php _e('Search...', 'pinboxes_template'); ?>">
        ...
        if (!empty($get_categories['categories'])) {
            ...
            <li class="categories_trigger">
                <a href="#" target="_self"><i class="fa fa-filter"
                                              aria-hidden="true"></i> <?php _e('Categories', 'pinboxes_template'); ?>
                </a>
                <ul class="categories">
                    <li class="filter_all_files"><a
                                href="<?php echo CLIENT_VIEW_FILE_LIST_URL . (!empty($url_client_id) ? '?client=' . $url_client_id : ''); ?>"><?php _e('All files', 'pinboxes_template'); ?></a>
                    </li>
                    <?php
        ...
        ?>
        <li>
            <a href="<?php echo BASE_URI; ?>upload-from-computer.php" target="_self"><i class="fa fa-cloud-upload"
                                                                                        aria-hidden="true"></i> <?php _e('Upload files', 'pinboxes_template'); ?>
            </a>
        </li>
        <li>
            <a href="<?php echo BASE_URI; ?>process.php?do=logout" target="_self"><i class="fa fa-sign-out"
                                                                                     aria-hidden="true"></i> <?php _e('Logout', 'pinboxes_template'); ?>
            </a>
        </li>
    </ul>
</div>
        ...
        if (!$count) {
            ...
            <div class="photo_list">
                ...
                foreach ($my_files as $file) {
                    ...
                    <div class="photo <?php echo $file['expired'] == true ? 'expired' : ''; ?>">
                        <div class="photo_int">
                    ...
                    if (file_exists($file_absolute_path)) {
                        ...
                        _e('File size:', 'pinboxes_template'); ?>
                                        <strong><?php echo $this_file_size; ?></strong>
                                        <?php
                    } ?>
                                </p>
                                ...
                                <p class="exp_date">
                                    ...
                                    if ($file['expires'] == '1') {
                                        ...
                                        _e('Expiration date:', 'pinboxes_template'); ?>
                                        <span><?php echo $exp_date; ?></span>
                                        <?php
                                    } ?>
                                </p>
                            </div>
                            <div class="download_link">
                                ...
                                if ($file['expired'] == false) { ?>
                                    ...
                                    _e('File expired', 'pinboxes_template');
                                } ?>
                            </div>
                        </div>
                    </div>
