                    ...
                    <div class="form-group group_float">
                        <select name="role" id="role" class="txtfield form-control">
                            ...
                            foreach ($roles_options as $val => $text) {
                                ?>
                                <option value="<?php echo $val; ?>" <?php echo isset($_GET['role']) && $_GET['role'] == $val ? 'selected="selected"' : ''; ?>><?php echo $text; ?></option>
                                <?php
                            }
                            ?>
                        </select>
        ...
        <form action="users.php" name="users_list" method="get" class="form-inline batch_actions">
                    ...
                    <div class="form_actions_submit">
                        <div class="form-group group_float">
                            <label for="action" class="control-label hidden-xs hidden-sm"><i
                                        class="glyphicon glyphicon-check"></i> <?php _e('Selected users actions', 'cftp_admin'); ?>
                                :</label>
            ...
            <div class="form_actions_count">
                <p><?php _e('Found', 'cftp_admin'); ?>:
                    <span><?php echo $count_for_pagination; ?> <?php _e('users', 'cftp_admin'); ?></span></p>
            </div>
            ...
            if ($count > 0) {
                ...
                while ($row = $sql->fetch()) {
                    ...
                    if ($count_workspaces > 0) {
                        $workspaces_link = 'workspaces.php?member=' . $user_data["id"];
