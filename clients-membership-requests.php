        ...
        <form action="<?php echo $this_page; ?>" name="requests_list" method="post" class="form-inline batch_actions">
                    ...
                    <div class="form_actions_submit">
                        <div class="form-group group_float">
                            <label for="action" class="control-label hidden-xs hidden-sm"><i
                                        class="glyphicon glyphicon-check"></i> <?php _e('Selected requests actions', 'cftp_admin'); ?>
                                :</label>
            ...
            <div class="form_actions_count">
                <p><?php _e('Found', 'cftp_admin'); ?>:
                    <span><?php echo $found_count; ?><?php _e('requests', 'cftp_admin'); ?></span></p>
            </div>
            ...
            <div class="form_results_filter">
                ...
                foreach ($filters as $type => $filter) {
                    ?>
                    <a href="<?php echo $filter['link']; ?>"
                       class="<?php echo $current_filter == $type ? 'filter_current' : 'filter_option' ?>"><?php echo $filter['title']; ?>
                        (<?php echo $filter['count']; ?>)</a>
                    <?php
                }
                ?>
            </div>
