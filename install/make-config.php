...
require_once ABS_PARENT . '/header-unlogged.php';
?>
            ...
            <div class="white-box-interior">
                ...
                if (!empty($config_file_written)) {
                    ...
                    <div class="inside_form_buttons">
                        <a href="index.php"
                           class="btn btn-wide btn-primary"><?php _e('Continue to installation', 'cftp_admin'); ?></a>
                    </div>
                    <?php
                } else {
                    ?>
                    ...
                    <form action="make-config.php" name="installform" method="post" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label for="dbdriver"
                                   class="col-sm-4 control-label"><?php _e('Select driver', 'cftp_admin'); ?></label>
                            <div class="col-sm-6">
                                <div class="radio <?php echo !$pdo_mysql_available ? 'disabled' : ''; ?>">
                                    <label for="dbdriver_mysql">
                                        <input type="radio" id="dbdriver_mysql" name="dbdriver"
                                               value="mysql" <?php echo !$pdo_mysql_available ? 'disabled' : ''; ?> <?php echo $post_vars['dbdriver'] == 'mysql' ? 'checked' : ''; ?> />
                                        MySQL <?php echo !$pdo_mysql_available ? _e('(not supported)', 'cftp_admin') : ''; ?>
                                    </label>
                                </div>
                                <div class="radio <?php echo !$pdo_mssql_available ? 'disabled' : ''; ?>">
                                    <label for="dbdriver_mssql">
                                        <input type="radio" id="dbdriver_mssql" name="dbdriver"
                                               value="mssql" <?php echo !$pdo_mssql_available ? 'disabled' : ''; ?> <?php echo $post_vars['dbdriver'] == 'mssql' ? 'checked' : ''; ?> />
                                        MS SQL
                                        Server <?php echo !$pdo_mssql_available ? _e('(not supported)', 'cftp_admin') : ''; ?>
                                    </label>
                                </div>
                            </div>
                            <div class="col-sm-2">
                        ...
                        <div class="form-group">
                            <label for="dbhost"
                                   class="col-sm-4 control-label"><?php _e('Host', 'cftp_admin'); ?></label>
                            <div class="col-sm-6">
                                <input type="text" name="dbhost"
                                       id="dbhost" <?php echo !$pdo_driver_available ? 'disabled' : ''; ?>
                                       class="required form-control" value="<?php echo $post_vars['dbhost']; ?>"/>
                            </div>
                            <div class="col-sm-2">
                        ...
                        <div class="form-group">
                            <label for="dbname"
                                   class="col-sm-4 control-label"><?php _e('Database name', 'cftp_admin'); ?></label>
                            <div class="col-sm-6">
                                <input type="text" name="dbname"
                                       id="dbname" <?php echo !$pdo_driver_available ? 'disabled' : ''; ?>
                                       class="required form-control" value="<?php echo $post_vars['dbname']; ?>"/>
                            </div>
                            <div class="col-sm-2">
                                <?php pdo_status_label(); ?>
                            </div>
                        ...
                        <div class="form-group">
                            <label for="dbuser"
                                   class="col-sm-4 control-label"><?php _e('Username', 'cftp_admin'); ?></label>
                            <div class="col-sm-6">
                                <input type="text" name="dbuser"
                                       id="dbuser" <?php echo !$pdo_driver_available ? 'disabled' : ''; ?>
                                       class="required form-control" value="<?php echo $post_vars['dbuser']; ?>"/>
                            </div>
                            <div class="col-sm-2">
                                <?php pdo_status_label(); ?>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="dbpassword"
                                       id="dbpassword" <?php echo !$pdo_driver_available ? 'disabled' : ''; ?>
                                       class="required form-control" value="<?php echo $post_vars['dbpassword']; ?>"/>
                            </div>
                            <div class="col-sm-2">
                                <?php pdo_status_label(); ?>
                            </div>
                        ...
                        <div class="form-group">
                            <label for="dbprefix"
                                   class="col-sm-4 control-label"><?php _e('Table prefix', 'cftp_admin'); ?></label>
                            <div class="col-sm-6">
                                <input type="text" name="dbprefix"
                                       id="dbprefix" <?php echo !$pdo_driver_available ? 'disabled' : ''; ?>
                                       class="required form-control" value="<?php echo $post_vars['dbprefix']; ?>"/>
                            </div>
                            <div class="col-sm-2">
                                <?php
                                if ($pdo_connected) {
                            ...
                            <?php if ($table_exists) : ?>
                                <div class="form-group">
                                    <div class="col-sm-offset-4 col-sm-6">
                                        <div class="checkbox">
                                            <label for="dbreuse">
                                                <input type="checkbox" name="dbreuse" id="dbreuse"
                                                       value="reuse" <?php echo $post_vars['dbreuse'] == 'reuse' ? 'checked' : ''; ?> /> <?php _e('Reuse existing tables', 'cftp_admin'); ?>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-sm-2"><?php echo $reuse_tables ? $status_indicator_ok : ''; ?></div>
                                </div>
                            <?php endif; ?>
                        <?php endif; ?>
                        ...
                        <div class="form-group">
                            <label for="lang"
                                   class="col-sm-4 control-label"><?php _e('Language', 'cftp_admin'); ?></label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <label for="maxfilesize"
                                   class="col-sm-4 control-label"><?php _e('Default maximum upload file size', 'cftp_admin'); ?></label>
                            <div class="col-sm-6">
                                <input type="number" name="maxfilesize" id="maxfilesize" class="required form-control"
                                       value="<?php echo (!empty($post_vars['maxfilesize'])) ? $post_vars['maxfilesize'] : '2048'; ?>"/>
                        ...
                        ?>
                            <div class="form-group">
                                <label for="<?php echo $values['name']; ?>"
                                       class="col-sm-4 control-label"><?php _e($values['label'], 'cftp_admin'); ?></label>
                                <div class="col-sm-6">
                                    <input type="text" name="<?php echo $values['name']; ?>"
                                           id="<?php echo $values['name']; ?>" class="form-control" disabled
                                           value="<?php echo $values['value']; ?>"/>
                                </div>
                            </div>
                            <?php
                    } ?>
                        ...
                        <div class="inside_form_buttons">
                            <?php if ($ready_to_go) : ?>
                                <button type="submit" name="submit"
                                        class="btn btn-wide btn-secondary"><?php _e('Check again', 'cftp_admin'); ?></button>
                                <button type="submit" name="submit-start"
                                        class="btn btn-wide btn-primary"><?php _e('Write config file', 'cftp_admin'); ?></button>
                            <?php else : ?>
                                <button type="submit" name="submit"
                                        class="btn btn-wide btn-primary"><?php _e('Check', 'cftp_admin'); ?></button>
                            <?php endif; ?>
                        </div>
...
<?php
require_once ABS_PARENT . '/footer.php';
